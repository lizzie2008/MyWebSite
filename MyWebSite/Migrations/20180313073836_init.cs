    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EssayArchiveID = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    Name = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EssayArchives", x => x.EssayArchiveID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EssayCatalogID = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    Name = table.Column<string>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EssayTagID = table.Column<int>(nullable: false)
                        .Annotation("MySQL:AutoIncrement", true),
                    Name = table.Column<string>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EssayID = table.Column<string>(nullable: false),
                    Content = table.Column<string>(nullable: true),
                    CreateTime = table.Column<DateTime>(nullable: false),
                    EssayArchiveID = table.Column<int>(nullable: true),
                    EssayCatalogID = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Essays_EssayArchiveID",
                table: "Essays",
                column: "EssayArchiveID");

            migrationBuilder.CreateIndex(
                name: "IX_Essays_EssayCatalogID",
                table: "Essays",
